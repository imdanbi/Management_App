...
public class MainCourseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_main_course, container, false);

       courseFragment = new CourseFragment();
       cultureFragment = new CultureFragment();


        getChildFragmentManager().beginTransaction().replace(R.id.tab1_container, courseFragment).commit();
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getChildFragmentManager().beginTransaction().replace(R.id.tab1_container, cultureFragment).commit();
            }
        });
