...
public class pplus2_activity extends AppCompatActivity implements View.OnClickListener {
    TextView total, question;
    Button answer1, answer2, answer3, answer4;
    Button submitbt;

    int score = 0;
    int totalquestion = Question.question_2.length;
    int curquestion = 0;
    String select = "";
    ...
    void new_change() {
        ...
        question.setText(Question.question_2[curquestion]);
        answer1.setText(Question.answers_2[curquestion][0]);
        answer2.setText(Question.answers_2[curquestion][1]);
        answer3.setText(Question.answers_2[curquestion][2]);
        answer4.setText(Question.answers_2[curquestion][3]);
    }
